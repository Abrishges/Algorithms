...
public class BinaryTree {
  ...
  // we can modify this methods to count non-lefts , just return zero if node is null
  ...
  // we can also use iterative program to count the nodes(leaf nodes can also be easily counted)
